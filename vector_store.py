...
# Соответствие активных файлов из data/ (без .txt) и кода для фильтра по кодексу/типу документа
FILE_TO_CODE = {
    # Иски и кодексы
...
if __name__ == "__main__":
    ...
    # Загрузка документов из активной папки data/
    vector_store.load_documents_from_folder("data")
    
    # Поиск
    results = vector_store.search("Как подать иск по ГПК?", top_k=3)
    print("\nРезультаты поиска:")
