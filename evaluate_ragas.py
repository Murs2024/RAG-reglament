...
def _get_dataset_class():
    """Загружает datasets только для сценариев, где нужен RAGAS Dataset."""
    from datasets import Dataset
    return Dataset


def _load_ragas_dependencies():
    """Ленивая загрузка RAGAS, чтобы служебные функции импортировались без optional-интеграций."""
...
def run_ragas_evaluation(pipeline):
    ...
    evaluate, faithfulness, context_precision = _load_ragas_dependencies()
